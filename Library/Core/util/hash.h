...
private:
    unsigned int left_rotate(unsigned int x, std::size_t n) { return (x << n) ^ (x >> (32 - n)); }
...
struct hash
{
    size_t operator()(const T& o) const { return _hash_detail::dispatch_hash(o); }
};
...
struct hash<std::tuple<Types...>>
{
    ...
    struct tuple_hash
    {
        ...
        {
            return hash_combine(
                _hash_detail::simple_get_hash(std::get<idx>(t)), tuple_hash<idx - 1, Ts...>()(t));
        }
    };
